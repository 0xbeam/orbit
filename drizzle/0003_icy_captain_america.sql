CREATE TABLE `build_log` (
	...
	`phase` text,
	`timestamp` text,
	`can_rollback` integer DEFAULT false,
	`rolled_back` integer DEFAULT false,
	`created_at` text DEFAULT '2026-03-05T17:59:14.547Z'
);
...
CREATE TABLE `__new_calendar_events` (
	...
	`metadata` text,
	`created_at` text DEFAULT '2026-03-05T17:59:14.547Z',
	`updated_at` text DEFAULT '2026-03-05T17:59:14.547Z'
);
--> statement-breakpoint
INSERT INTO `__new_calendar_events`("id", "google_event_id", "calendar_id", "title", "description", "location", "start_at", "end_at", "all_day", "status", "attendees", "organizer", "meet_link", "recurring_event_id", "visibility", "contact_ids", "is_internal", "metadata", "created_at", "updated_at") SELECT "id", "google_event_id", "calendar_id", "title", "description", "location", "start_at", "end_at", "all_day", "status", "attendees", "organizer", "meet_link", "recurring_event_id", "visibility", "contact_ids", "is_internal", "metadata", "created_at", "updated_at" FROM `calendar_events`;--> statement-breakpoint
...
CREATE TABLE `__new_contacts` (
	...
	`created_at` text DEFAULT '2026-03-05T17:59:14.545Z',
	`updated_at` text DEFAULT '2026-03-05T17:59:14.546Z',
	`phone` text,
	`linkedin_url` text,
	`twitter_url` text,
	`telegram_url` text,
...
CREATE TABLE `__new_drafts` (
	...
	`created_at` text DEFAULT '2026-03-05T17:59:14.546Z',
	`updated_at` text DEFAULT '2026-03-05T17:59:14.546Z',
	FOREIGN KEY (`contact_id`) REFERENCES `contacts`(`id`) ON UPDATE no action ON DELETE no action
);
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_email_messages`("id", "gmail_message_id", "thread_id", "contact_id", "direction", "from_address", "to_address", "cc_address", "subject", "snippet", "body_text", "body_html", "date", "label_ids", "is_read", "has_attachments", "metadata", "created_at") SELECT "id", "gmail_message_id", "thread_id", "contact_id", "direction", "from_address", "to_address", "cc_address", "subject", "snippet", "body_text", "body_html", "date", "label_ids", "is_read", "has_attachments", "metadata", "created_at" FROM `email_messages`;--> statement-breakpoint
...
CREATE TABLE `__new_email_threads` (
	`id` text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_email_threads`("id", "gmail_thread_id", "contact_id", "subject", "snippet", "last_message_at", "message_count", "is_unread", "is_starred", "is_replied", "status", "labels", "metadata", "created_at", "updated_at") SELECT "id", "gmail_thread_id", "contact_id", "subject", "snippet", "last_message_at", "message_count", "is_unread", "is_starred", "is_replied", "status", "labels", "metadata", "created_at", "updated_at" FROM `email_threads`;--> statement-breakpoint
DROP TABLE `email_threads`;--> statement-breakpoint
ALTER TABLE `__new_email_threads` RENAME TO `email_threads`;--> statement-breakpoint
...
CREATE TABLE `__new_meeting_notes` (
	`id` text PRIMARY KEY NOT NULL,
	`contact_id` text,
	`title` text,
	`content` text,
...
--> statement-breakpoint
INSERT INTO `__new_meeting_notes`("id", "contact_id", "title", "content", "meeting_date", "source", "created_at", "updated_at") SELECT "id", "contact_id", "title", "content", "meeting_date", "source", "created_at", "updated_at" FROM `meeting_notes`;--> statement-breakpoint
DROP TABLE `meeting_notes`;--> statement-breakpoint
ALTER TABLE `__new_meeting_notes` RENAME TO `meeting_notes`;--> statement-breakpoint
